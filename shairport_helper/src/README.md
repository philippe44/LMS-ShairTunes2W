Squeezebox ShairPort Helper
===========================
Based on Shairport by [James Laird](mailto:jhl@mafipulation.org) ([announcement](http://mafipulation.org/blagoblig/2011/04/08#shairport))
...
How to use it
-------------
Build the shairport_helper binary and use it with the Shairport Squeezebox Plugin
